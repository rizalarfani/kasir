							...
							<div class="table-responsive">
								<table class="table table-hover dataTable">
									...
									<tbody>
										...
										if ($data) {
											foreach ($data as $d) {
												$cek_inv =  $this->M_pelunasan->cek_inven($d->code_pay);
												if ($cek_inv == 0) { ?>
														...
														<td>
															<div class="btn-group">
																<?php if (uri(2) == 'it') {
																	...
																	<?php } else { ?>
																		<a href="<?php echo url(1) . '_inven/lihat/' . enkrip($d->code_pay); ?>" class="btn btn-xs btn-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat data">
																			<i class="fa fa-eye"></i>
																		</a>
																	<?php } ?>
