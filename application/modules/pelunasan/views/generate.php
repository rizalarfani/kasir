				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							...
							<?php echo form_open(base_url('pelunasan/generate')); ?>
							<div class="row">
								<div class="col-md-6">
									...
									<tbody>
										...
										?>
												<tr style="vertical-align:middle">
													...
													<td class="text-end"><?php echo format_rupiah($d->jumlah); ?></td>
													<td><?= $d->order_date; ?></td>
												</tr>
											<?php }
										} else { ?>
									...
									<?php if ($data) { ?>
										<tfoot>
											<tr>
												...
												<th><a class="btn btn-warning" href="<?= base_url('pelunasan/proses_generate/' . $akhir); ?>">Generate</a></th>
											</tr>
										</tfoot>
									<?php } ?>
								</table>
