                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="float-end mt-3">
                                            <p><strong>Order Date: </strong> <?= $data[0]->order_date; ?></p>
                                            <p class="m-t-10"><strong>Kasir: </strong> <span class="label label-pink"><?php
                                                                                                                        $kasir = $this->M_pembelian->get_kasir($data[0]->order_number);
                                                                                                                        echo  $kasir->user_namalengkap;
                                                                                                                        ?></span></p>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data as $d) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= format_rupiah($d->order_qty * $d->harga); ?></td>
                                                        </tr>
                                                    <?php } ?>
