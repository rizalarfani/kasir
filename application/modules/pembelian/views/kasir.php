				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							...
							<?php echo form_open(base_url('pembelian/data')); ?>
							<div class="row">
								<div class="col-md-6">
								...
								<table class="table table-hover dataTable">
									...
									<tbody>
										...
										?>
												<tr style="vertical-align:middle">
													...
													<td><?php echo $d->total_items; ?></td>
													<td class="text-end"><?php echo $d->total_price; ?></td>
													<td><?= $d->order_date; ?></td>
													<td>
													 <div class="btn-group">
									...
									<tfoot>
										<tr>
											...
											<th class="text-end">	<?= format_rupiah(array_sum($t_jml)); ?></th>
											<th colspan="2">
											</th>
										</tr>
									</tfoot>
